...
public class NewCustomerPageUI {
	public static final String NEW_CUSTOMER_TITLE = "//p[text()='Add New Customer']";
	public static final String CUSTOMER_NAME_TEXTBOX = "//input[@name='name']";
	public static final String MALE_GENDER_RADIO = "//input[@value='m']";
	public static final String FEMALE_GENDER_RADIO = "//input[@value='f']";
